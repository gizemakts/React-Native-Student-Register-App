...
import { studentChanged, studentUpdate, studentDelete } from '../actions';
...
export default connect(mapToStateProps, { studentChanged, studentUpdate, studentDelete })(StudentUpdate);